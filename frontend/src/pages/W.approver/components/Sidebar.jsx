    ...
    <aside className="w-64 bg-white border-r border-slate-100 flex flex-col h-screen fixed left-0 top-0 overflow-y-auto z-20">
      <div className="p-6">
        <div className="flex items-center gap-3 font-bold text-lg text-blue-600">
          ...
          <div className="leading-tight">
            ...
            <span className="text-[9px] uppercase tracking-wider text-slate-400">Woreda Approver</span>
          </div>
        </div>
      </div>
      ...
      <div className="px-6 py-4">
        <div className="bg-slate-50 rounded-xl p-3 flex flex-col gap-1 border border-slate-100">
          ...
          <span className="text-sm font-bold text-slate-800">Woreda Approver</span>
